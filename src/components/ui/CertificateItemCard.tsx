    ...
    >
      ...
      <div className="flex-grow min-w-0 flex flex-col sm:justify-center">
        ...
        <div className="flex justify-between items-start mb-1 sm:hidden">
          <h3 className="font-semibold text-md text-zinc-800 dark:text-zinc-100 break-words pr-2 max-w-[75%]">
            {certificate.title}
          </h3>
          <Badge
            variant="outline"
        ...
        {/* Desktop view - Badge inline with title */}
        <div className="hidden sm:flex sm:flex-wrap sm:items-center sm:gap-1.5 mb-1.5">
        ...
        <div className="flex flex-col sm:gap-1">
          <span className="text-sm md:text-md text-zinc-600 dark:text-zinc-400">
            {certificate.issuer}
          </span>
          {certificate.description && (
            <p className="text-xs md:text-sm text-zinc-500 dark:text-zinc-500 line-clamp-2 sm:line-clamp-1">
              {certificate.description}
            </p>
          )}
        </div>
